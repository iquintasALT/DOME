...
WeaponBehaviour::WeaponBehaviour(Manager* mngr, Vector2D playerPos, Transform* playerTr) : GameObject(mngr), pl(playerTr), weapon(nullptr), animator_(nullptr), inv_(nullptr) {
	mngr->addEntity(this);
