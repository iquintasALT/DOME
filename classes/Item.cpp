...
ItemInfo* ItemInfo::classicAmmo()
{
	...
	return new ItemInfo(CLASSIC_AMMO, "classic ammo", "Bullets for the classic weapon", 1, 1, 2, 1, f);
}
...
ItemInfo* ItemInfo::metalPlates()
{
	...
	return new ItemInfo(METAL_PLATES, "metal plates", "Metal plates", 2, 2, 7, 1, f);
}
