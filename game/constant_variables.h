...
namespace consts {
	...
	const float TRAVEL_TO_NUCLEAR_POWER_STATION_TIREDNESS = 0.1f;
	const float TRAVEL_TO_SUPERMARKET_TIREDNESS = 0.15;
	const float TRAVEL_TO_COMUNICATIONS_TIREDNESS = 0.20f;
	const float TRAVEL_TO_HOSPITAL_TIREDNESS = 0.25f;
	const float TRAVEL_TO_SHOP_TIREDNESS = 0.3f;
